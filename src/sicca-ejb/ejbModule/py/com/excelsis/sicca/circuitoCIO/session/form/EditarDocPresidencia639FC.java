...
@Name("editarDocPresidencia639FC")
public class EditarDocPresidencia639FC implements Serializable {
	...
	private String nombrePantalla = "EditarDocumPresidenciaConcursoInterno";
	...
	private void validarOee() {
		...
		seguridadUtilFormController.verificarPerteneceOeeCIO(null, concursoPuestoAgr.getIdConcursoPuestoAgr(), seguridadUtilFormController.estadoActividades("ESTADOS_GRUPO", "CON DECRETO")
			+ "", ActividadEnum.CIO_EDITAR_DOC_PRESIDENCIA_REPUBLICA.getValor());
	}
	...
	public String nextTask() {
		...
		jbpmUtilFormController.setActividadActual(ActividadEnum.CIO_EDITAR_DOC_PRESIDENCIA_REPUBLICA);
