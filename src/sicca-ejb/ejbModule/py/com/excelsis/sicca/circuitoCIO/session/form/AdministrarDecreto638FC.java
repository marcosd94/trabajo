...
@Name("administrarDecreto638FC")
public class AdministrarDecreto638FC implements Serializable {
	...
	private String nombrePantalla = "administrarDecreto_edit_ConcursoInterno’";
	...
	private void validarOee() {
		...
		seguridadUtilFormController.verificarPerteneceOeeCIO(null, concursoPuestoAgr.getIdConcursoPuestoAgr(), seguridadUtilFormController.estadoActividades("ESTADOS_GRUPO", "PERMANENTE N12")
			+ "", ActividadEnum.CIO_ELABORAR_DECRECTO_PRESIDENCIAL.getValor());
	}
	...
	public String nextTask() {
		...
		jbpmUtilFormController.setActividadActual(ActividadEnum.CIO_ELABORAR_DECRECTO_PRESIDENCIAL);
		jbpmUtilFormController.setActividadSiguiente(ActividadEnum.CIO_EDITAR_DOC_PRESIDENCIA_REPUBLICA);
