...
@Name("evaluacionAdjudicadoCU634FC")
public class EvaluacionAdjudicadoCU634FC {
	...
	public String getUrlToPageEvaluarDocAdjudicado() {
		return "/circuitoCIO/evaluacionDocumentosAdjudicados/EvaluarDocAdjudicado.xhtml?fromToPage=circuitoCIO/evaluacionDocumentosAdjudicados/EvalDocumentalCabEdit&concursoPuestoAgrIdConcursoPuestoAgr="
				+ concursoPuestoAgr.getIdConcursoPuestoAgr();
	}
