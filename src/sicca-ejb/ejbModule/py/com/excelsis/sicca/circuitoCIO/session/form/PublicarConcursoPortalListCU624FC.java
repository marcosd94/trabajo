...
@Name("publicarConcursoPortalListCU624FC")
public class PublicarConcursoPortalListCU624FC {
	...
	private void validarOee() {
		...
		seguridadUtilFormController.verificarPerteneceOeeCIO(
				...
				seguridadUtilFormController.estadoActividades("ESTADOS_GRUPO",
						"MODIFICADO DATOS") + "",
				ActividadEnum.CIO_SOLICITAR_PUBLICACION.getValor());
	}
	...
	public String getUrlToPageSolicitarAprobacion() {
		return "/circuitoCIO/publicarConcursoPortal/SolicitarAprobacionSFP.xhtml?fromToPage=circuitoCIO/publicarConcursoPortal/PublicacionConcursoCabList&idConcursoPuestoAgr="
				+ concursoPuestoAgr.getIdConcursoPuestoAgr();
	}

	public String getUrlToPagePublicacionConcurso() {
		return "/circuitoCIO/publicarConcursoPortal/PublicacionConcursoCabList.xhtml?fromToPage=circuitoCIO/publicarConcursoPortal/SolicitarAprobacionSFP&idConcursoPuestoAgr="
				+ concursoPuestoAgr.getIdConcursoPuestoAgr();
	}
	...
	private void cancelarGrupo(ConcursoPuestoAgr ag) {
		...
		jbpmUtilFormController
				.setActividadActual(ActividadEnum.CIO_SOLICITAR_PUBLICACION);
	...
	public String siguienteTarea() {
		try {
			...
			jbpmUtilFormController
					.setActividadActual(ActividadEnum.CIO_SOLICITAR_PUBLICACION);
			jbpmUtilFormController
					.setActividadSiguiente(ActividadEnum.CIO_APROBAR_PUBLICACION);
	...
	private List<Object[]> consulta1(Long idGrupo) {
		try {
			String sql = "select distinct(agr.id_concurso_puesto_agr) as id,  "
					...
					+ "where puesto_det.activo = true and agr.id_concurso_puesto_agr = "
					+ idGrupo;
