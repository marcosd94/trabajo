...
@Name("listaLargaCU630FC")
public class ListaLargaCU630FC {
	...
	private void validarOee() {
		...
		seguridadUtilFormController.verificarPerteneceOeeCIO(
				...
				ActividadEnum.CIO_ELABORAR_PUBLICACION_LISTA_LARGA.getValor());
...
//				listaDatosReporte, param);
		...
		JasperReportUtils.respondPDF("RPT_CU167_Lista_Larga_Admitidos_aux", false,listaDatosReporte, param);
...
//				listaDatosReporte, param);
	...
	private List<Object[]> consulta_NO_Admitidos() {
		String sql = "select per_post.usu_alta, eval_cab.id_eval_documental_cab as id, eval_cab.observacion"
				...
				+ "and agr.id_concurso_puesto_agr = "
				+ concursoPuestoAgr.getIdConcursoPuestoAgr()
				+ " order by per_post.documento_identidad";
		try {
	...
	public String getUrlToPageListaLargaEdit() {
		return "/circuitoCIO/listaLarga/ListaLargaEdit.xhtml?fromToPage=circuitoCIO/listaLarga/ListaLargaList&concursoPuestoAgrIdConcursoPuestoAgr="
				+ concursoPuestoAgr.getIdConcursoPuestoAgr();
	}

	public String getUrlToPageListaLargaList() {
		return "/circuitoCIO/listaLarga/ListaLargaList.xhtml?fromToPage=circuitoCIO/listaLarga/ListaLargaEdit&concursoPuestoAgrIdConcursoPuestoAgr="
				+ concursoPuestoAgr.getIdConcursoPuestoAgr();
	}
	...
	public String nextTask() {
		try {
			...
			jbpmUtilFormController
					.setActividadActual(ActividadEnum.CIO_ELABORAR_PUBLICACION_LISTA_LARGA);
			jbpmUtilFormController
					.setActividadSiguiente(ActividadEnum.CIO_REALIZAR_EVALUACIONES);
