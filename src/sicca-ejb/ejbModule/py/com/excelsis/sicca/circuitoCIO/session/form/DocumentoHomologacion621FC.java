...
@Name("documentoHomologacion621FC")
public class DocumentoHomologacion621FC implements Serializable {
	...
	private String nombrePantalla = "AdministrarDocumentosDeHomologacionConcursoInterno";
	...
	private void validarOee(Concurso concurso) {
		...
		seguridadUtilFormController.verificarPerteneceOeeCIO(concurso.getConfiguracionUoCab().getIdConfiguracionUo(), concursoPuestoAgr.getIdConcursoPuestoAgr(), seguridadUtilFormController.estadoActividades("ESTADOS_GRUPO", "HOMOLOGADO")+"", ActividadEnum.CIO_ELABORAR_DOC_HOMOLOG.getValor());
	...
	public String nextTask() {
		...
		jbpmUtilFormController.setActividadActual(ActividadEnum.CIO_ELABORAR_DOC_HOMOLOG);
	...
	public void anexar() {
		...
		direccionFisica =
			"//SICCA//" + anio + "//" + configuracionUoCab.getIdConfiguracionUo() + "//"
				...
				+ idConcurso;
		from =
			"circuitoCIO/admDocumentoHomologacion621/DocumentoHomologacion621?concursoPuestoAgrIdConcursoPuestoAgr="
				+ idConcursoPuestoAgr;
