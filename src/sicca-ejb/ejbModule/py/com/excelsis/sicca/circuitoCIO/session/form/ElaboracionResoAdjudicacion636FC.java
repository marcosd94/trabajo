...
@Name("elaboracionResoAdjudicacion636FC")
public class ElaboracionResoAdjudicacion636FC implements Serializable {
	...
	private String nombrePantalla = "elaborarResolucionAdjudicacion_edit_ConcursoInterno";
	...
	private boolean mostrarAnexo=false;


	public void init() {
		concursoPuestoAgr = em.find(ConcursoPuestoAgr.class, idConcursoPuestoAgr);
		validarOee();
		codActividad=ActividadEnum.CIO_ELABORAR_RESOLUCION_ADJUDICACION.getValor();
	...
	public String anexar(Long idConcursoPuestoAgr) {
		...
		String idCU = idConcursoPuestoAgr+"";
		String nombreTabla = "Resolucion";
		String mostrarDoc = "true";
		String isEdit = "true";
		String from = "circuitoCIO/elaboracionResoAdjudicacion636/ElaboracionResoAdjudicacion636";
	 ...
	 public String endTask(ConcursoPuestoAgr cAgr){
		 try {
			...
			jbpmUtilFormController.setActividadActual(ActividadEnum.CIO_ELABORAR_RESOLUCION_ADJUDICACION);
	...
	private void validarOee() {
		...
		seguridadUtilFormController.verificarPerteneceOeeCIO(null, concursoPuestoAgr.getIdConcursoPuestoAgr(), seguridadUtilFormController.estadoActividades("ESTADOS_GRUPO", "ADJUDICADO")
			+ "", ActividadEnum.CIO_ELABORAR_RESOLUCION_ADJUDICACION.getValor());
	}
	...
	public String nextTask() {
		...
		for (int i = 0; i < puestoAgrList.size(); i++) {
			 ...
			 * CONCURSO_PUESTO_DET. incidencia 0001348  
			 * se modifico el query incidencia 0001643
			 * */
		...
		jbpmUtilFormController.setActividadActual(ActividadEnum.CIO_ELABORAR_RESOLUCION_ADJUDICACION);
		jbpmUtilFormController.setActividadSiguiente(ActividadEnum.CIO_FIRMAR_RESOLUCION_ADJUDICACION);
	...
	public void habAnexar(Long idConcurso) {
		Concurso concurso=em.find(Concurso.class, idConcurso);
		if(seleccionUtilFormController.esConcursoInternoOposicionInter(concurso.getDatosEspecificosTipoConc()))
			mostrarAnexo= true;
		else
			mostrarAnexo= false;
	}
	...
	public boolean isMostrarAnexo() {
		return mostrarAnexo;
	}


	public void setMostrarAnexo(boolean mostrarAnexo) {
		this.mostrarAnexo = mostrarAnexo;
	}
