...
@Name("promocionEvalDesempenho664ListFC")
public class PromocionEvalDesempenho664ListFC{
	@In
	...
	private Long getIdTipoMovilidad(){
		return seleccionUtilFormController.traerDatosEspecificos("TIPOS DE INGRESOS Y MOVILIDAD","PROMOCION POR EVALUACION DE DESEMPENO").getIdDatosEspecificos();
	}
