...
@Name("interrupcionTrasladoTmpListCU747")
public class InterrupcionTrasladoTmpListCU747 {
	...
	private void searchDatosEsp() {
		Query q = em
				.createQuery("select especif from DatosEspecificos especif "
						+ " where especif.activo is true and especif.descripcion = 'INTERRUPCION TRASLADO TEMPORAL' "
	...
	public void search() {
		...
		empleadoPuestoList.setIdTipoIngreso(dato.getIdDatosEspecificos());
		empleadoPuestoList.listaResultadosCU663();
	}
