...
@Name("promocionSinConcurso665ListFC")
public class PromocionSinConcurso665ListFC{
	@In
	...
	private Long getIdTipoMovilidad(){
		return seleccionUtilFormController.traerDatosEspecificos("TIPOS DE INGRESOS Y MOVILIDAD","PROMOCION SIN CONCURSO").getIdDatosEspecificos();
	}
