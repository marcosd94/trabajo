...
@Name("nuevasFuncionesList706FC")
public class NuevasFuncionesList706FC{
	@In
	...
	private Long getIdTipoMovilidad(){
		return seleccionUtilFormController.traerDatosEspecificos("TIPOS DE INGRESOS Y MOVILIDAD","EN ESPERA DE ASIGNACION DE NUEVAS FUNCIONES").getIdDatosEspecificos();
	}
