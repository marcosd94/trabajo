...
@Name("transladoLineaSinSolic711ListFC")
public class TransladoLineaSinSolic711ListFC {
	@In
	...
	private Long getIdTipoMovilidad() {
		if (cuNro.equalsIgnoreCase("711"))
			return seleccionUtilFormController.traerDatosEspecificos("TIPOS DE INGRESOS Y MOVILIDAD", "TRASLADO DEFINITIVO CON LINEAS DE CARGO").getIdDatosEspecificos();
		else if (cuNro.equalsIgnoreCase("712"))
			return seleccionUtilFormController.traerDatosEspecificos("TIPOS DE INGRESOS Y MOVILIDAD", "TRASLADO DEFINITIVO SIN LINEAS DE CARGO").getIdDatosEspecificos();
		else if (cuNro.equalsIgnoreCase("710"))
			return seleccionUtilFormController.traerDatosEspecificos("TIPOS DE INGRESOS Y MOVILIDAD", "TRASLADO DEFINITIVO SIN LINEAS DE CARGO").getIdDatosEspecificos();
		else
			return null;
	}
