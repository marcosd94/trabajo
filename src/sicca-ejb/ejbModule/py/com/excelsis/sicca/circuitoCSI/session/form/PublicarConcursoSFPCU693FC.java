...
@Name("publicarConcursoSFPCU693FC")
public class PublicarConcursoSFPCU693FC {
	@In
	...
	private void validarOee() {
		...
		seguridadUtilFormController.verificarPerteneceOeeCSI(null, concursoPuestoAgr.getIdConcursoPuestoAgr(), seguridadUtilFormController.estadoActividades("ESTADOS_GRUPO", "A PUBLICAR")+"", ActividadEnum.CSI_APROBAR_PUBLICACION.getValor());
	}
	...
	public String getUrlToPagePrototipoAlternativo() {
		return "/circuitoCSI/publicacionConcursoCU692/SolicitarAprobacionSFP.xhtml?fromToPage=circuitoCSI/publicacionConcursoCU692/PublicacionConcursoCabList&idConcursoPuestoAgr="
	...
	public boolean siguienteTarea(ConcursoPuestoAgr ag, String valor) {
		try {
			...
			jbpmUtilFormController.setActividadActual(ActividadEnum.CSI_APROBAR_PUBLICACION);
			if (valor.equals("recibir")) {
				jbpmUtilFormController.setActividadSiguiente(ActividadEnum.CSI_RECIBIR_POSTULACIONES);
				jbpmUtilFormController.setTransition("next2");
			}
			if (valor.equals("revision")) {
				jbpmUtilFormController.setActividadSiguiente(ActividadEnum.CSI_REVISION_PUBLICACION_OEE);
