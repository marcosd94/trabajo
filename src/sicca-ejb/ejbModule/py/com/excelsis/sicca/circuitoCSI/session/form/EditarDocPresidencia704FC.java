...
@Name("editarDocPresidencia704FC")
public class EditarDocPresidencia704FC implements Serializable {
	...
	private String nombrePantalla = "EditarDocumPresidenciaConcursoSimplificado";
	...
	private void validarOee() {
		...
		seguridadUtilFormController.verificarPerteneceOeeCSI(null, concursoPuestoAgr.getIdConcursoPuestoAgr(), seguridadUtilFormController.estadoActividades("ESTADOS_GRUPO", "CON DECRETO")
			+ "", ActividadEnum.CSI_EDITAR_DOC_PRESIDENCIA_REPUBLICA.getValor());
	}
	...
	public String nextTask() {
		...
		jbpmUtilFormController.setActividadActual(ActividadEnum.CSI_EDITAR_DOC_PRESIDENCIA_REPUBLICA);
		jbpmUtilFormController.setActividadSiguiente(ActividadEnum.CSI_INGRESAR_POSTULANTE);
	...
	public String anexar(Long idConcursoPuestoAgr) {
		...
		String nombrePantalla = "EditarDocumPresidenciaConcursoSimplificado";
		String idCU = grupo.getDecreto().getIdResolucion()+"";
		String nombreTabla = "Decreto";
		String mostrarDoc = "true";
		String isEdit = "true";
		String from = "circuitoCSI/editarDocPresidencia704/EditarDocPresidencia704";
