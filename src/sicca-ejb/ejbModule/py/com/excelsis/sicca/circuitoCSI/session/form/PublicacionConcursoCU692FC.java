...
@Name("publicacionConcursoCU692FC")
public class PublicacionConcursoCU692FC {
	@In
	...
	private void validarOee() {
		...
		seguridadUtilFormController.verificarPerteneceOeeCSI(
				...
				seguridadUtilFormController.estadoActividades("ESTADOS_GRUPO",
						"MODIFICADO DATOS") + "",
				ActividadEnum.CSI_SOLICITAR_PUBLICACION.getValor());
	}
	...
	public String getUrlToPagePublicacionConcurso() {
		return "/circuitoCSI/publicacionConcursoCU692/PublicacionConcursoCabList.xhtml?fromToPage=circuitoCSI/publicacionConcursoCU692/SolicitarAprobacionSFP&idConcursoPuestoAgr="
				+ concursoPuestoAgr.getIdConcursoPuestoAgr();
	}
	...
	private void cancelarGrupo(ConcursoPuestoAgr ag) {
		...
		jbpmUtilFormController
				.setActividadActual(ActividadEnum.CSI_SOLICITAR_PUBLICACION);
	...
	public String siguienteTarea() {
		try {
			...
			jbpmUtilFormController
					.setActividadActual(ActividadEnum.CSI_SOLICITAR_PUBLICACION);
			jbpmUtilFormController
					.setActividadSiguiente(ActividadEnum.CSI_APROBAR_PUBLICACION);
