...
@Name("elaborarResolucionNombramiento705FC")
public class ElaborarResolucionNombramiento705FC implements Serializable {
	...
	private String nombrePantalla = "resolucionNombramiento_editConcursoSimplificado";
	...
	private void validarOee() {
		...
		seguridadUtilFormController.verificarPerteneceOeeCSI(null, concursoPuestoAgr.getIdConcursoPuestoAgr(), seguridadUtilFormController.estadoActividades("ESTADOS_GRUPO", "PERMANENTE D12")
