...
@Name("publicacionSeleccionadosCU701FC")
public class PublicacionSeleccionadosCU701FC {
	@In
	...
	private void actualizarEstadosElegibles() {
		try {
			...
			jbpmUtilFormController
					.setActividadActual(ActividadEnum.CSI_PUBLICAR_ADJUDICADOS);
	...
	private void validarOee() {
		...
		seguridadUtilFormController.verificarPerteneceOeeCSI(
				...
				ActividadEnum.CSI_PUBLICAR_ADJUDICADOS.getValor());
	}
	...
	private String generarTextoPublicacion() {
		...
		String spanC = "</span>";
		String br = "</br>";
		texto.append(hr + fechaPublicacion + spanO + "Las personas seleccionadas son: " + spanC + br);
		texto.append(spanO);
	...
	public String nextTask() {
		...
		try {
			...
			jbpmUtilFormController
					.setActividadActual(ActividadEnum.CSI_PUBLICAR_ADJUDICADOS);
			jbpmUtilFormController
					.setActividadSiguiente(ActividadEnum.CSI_ELABORAR_RESOLUCION_ADJUDICACION);
			jbpmUtilFormController.setTransition("next");
