...
@Name("admDocHomologacion689FC")
public class AdmDocHomologacion689FC implements Serializable {
	...
	private String nombrePantalla = "AdministrarDocumentosDeHomologacionConcursoSimplificado";
	...
	private void validarOee(Concurso concurso) {
		...
		seguridadUtilFormController.verificarPerteneceOeeCSI(concurso.getConfiguracionUoCab().getIdConfiguracionUo(), concursoPuestoAgr.getIdConcursoPuestoAgr(), seguridadUtilFormController.estadoActividades("ESTADOS_GRUPO", "HOMOLOGADO")+"", ActividadEnum.CSI_ELABORAR_DOC_HOMOLOG.getValor());
	...
	public String nextTask() {
		...
		jbpmUtilFormController.setActividadActual(ActividadEnum.CSI_ELABORAR_DOC_HOMOLOG);
		jbpmUtilFormController.setActividadSiguiente(ActividadEnum.CSI_FIRMA_RESOL_HOMOLOG);
	...
	public void anexar() {
		...
		direccionFisica =
			"//SICCA//" + anio + "//" + configuracionUoCab.getIdConfiguracionUo() + "//"
				...
				+ idConcurso;
		from =
			"circuitoCSI/admDocHomologacion689/AdmDocHomologacion689?concursoPuestoAgrIdConcursoPuestoAgr="
				+ idConcursoPuestoAgr;
