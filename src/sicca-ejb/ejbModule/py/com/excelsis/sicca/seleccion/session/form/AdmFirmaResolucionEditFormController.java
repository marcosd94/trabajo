...
@Name("admFirmaResolucionEditFormController")
public class AdmFirmaResolucionEditFormController implements Serializable {
	...
	public String save() {
		try {
			...
			homologacionPerfilMatrizDet.setAjustadoOee(false); //JD 25/11
			homologacionPerfilMatrizDet.setAjusteEnviado(false);
			homologacionPerfilMatrizDet.setHomologacionPerfilMatriz(cabeceraHomologacionPerfilMatriz);
			homologacionPerfilMatrizDet.setFirmaResolucion(true);
