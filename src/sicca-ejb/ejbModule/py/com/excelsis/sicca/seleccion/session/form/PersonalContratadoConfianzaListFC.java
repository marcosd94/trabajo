...
@Name("personalContratadoConfianzaListFC")
public class PersonalContratadoConfianzaListFC{
	@In
	...
	private Long getIdTipoMovilidad(){
		return seleccionUtilFormController.traerDatosEspecificos("TIPOS DE INGRESOS Y MOVILIDAD","INGRESO DIRECTO DE PERSONAL CONTRATADO A PUESTO DE CONFIANZA").getIdDatosEspecificos();
	}
