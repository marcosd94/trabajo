...
@Name("otrasCarrerasEditFC")
@Scope(ScopeType.CONVERSATION)
public class OtrasCarrerasEditFC implements Serializable {
	...
	public String toFindPersonaView() {
		...
		String from="";
		if(idEmpleadoPuesto==null)
			from="/seleccion/ingresoDirecto/porOtrasCarreras/OtrasCarrerasEdit";
		else
			from="/seleccion/ingresoDirecto/porOtrasCarreras/OtrasCarreras";
	...
	public String toFindPersona() {
		idPersona=null;
		return "/seleccion/persona/PersonaEdit.xhtml?personaFrom=/seleccion/ingresoDirecto/porOtrasCarreras/OtrasCarrerasEdit";
	}
	public String toFindPersonaList() {
		return "/seleccion/persona/PersonaList.xhtml?from=/seleccion/ingresoDirecto/porOtrasCarreras/OtrasCarrerasEdit";
	}
	...
	public void seleccionarPuesto(Long idPuesto,int index){
		...
		public String save() {
			try {
				 ...
				 * */	
				empleadoPuesto.setDatosEspecificosByIdDatosEspTipoIngresoMovilidad(seleccionUtilFormController.traerDatosEspecificos("TIPOS DE INGRESOS Y MOVILIDAD","INGRESO DIRECTO PERSONAL OTRAS CARRERAS"));
