...
@Name("ingresoPorRenovacionContratoListFC")
public class IngresoPorRenovacionContratoListFC {
	...
	private void searchDatosEsp() {
		Query q = em
				.createQuery("select especif from DatosEspecificos especif "
						+ " where especif.activo is true and especif.descripcion = 'INGRESO DIRECTO PERSONAL RENOVACION CONTRATO' "
