...
@Name("permanenteConfElecListFC")
public class PermanenteConfElecListFC {
	@In
	...
	private Long getIdTipoMovilidad(){
		return seleccionUtilFormController.traerDatosEspecificos("TIPOS DE INGRESOS Y MOVILIDAD","INGRESO DIRECTO DE PERSONAL PERMANENTE A PUESTO DE CONFIANZA O ELECTIVO").getIdDatosEspecificos();
	}
