...
@Name("ingresoEspecialListFC")
public class IngresoEspecialListFC{
	@In
	...
	private Long getIdTipoMovilidad(){
		return seleccionUtilFormController.traerDatosEspecificos("TIPOS DE INGRESOS Y MOVILIDAD","INGRESO DIRECTO PERSONAL ESPECIAL").getIdDatosEspecificos();
	}
