...
@Name("resolucionNombramientoFromController")
public class ResolucionNombramientoFromController implements Serializable {
	...
	private String nombrePantalla = "resolucionNombramiento_edit";
...
//		seguridadUtilFormController.verificarPerteneceOee(null, concursoPuestoAgr.getIdConcursoPuestoAgr(), seguridadUtilFormController.estadoActividades("ESTADOS_GRUPO", "PERMANENTE D12")
//			+ "", ActividadEnum.ELABORAR_RESOLUCION_NOMBRAMIENTO.getValor());
	}
...
//		jbpmUtilFormController.setActividadActual(ActividadEnum.ELABORAR_RESOLUCION_NOMBRAMIENTO);
//		jbpmUtilFormController.setActividadSiguiente(ActividadEnum.FIRMAR_RESOLUCION_NOMBRAMIENTO);
	...
	public String resolucionSave() {
		...
		return "/seleccion/resolucionHomologacion/ResolucionHomologacionEdit.xhtml?"
			...
			+ paramIdConcurso
			+ "&"
			+ "fromCU=419&plantillaResolucionHomologacionFrom=seleccion/resolucionNombramiento/ResolucionNombramiento";
