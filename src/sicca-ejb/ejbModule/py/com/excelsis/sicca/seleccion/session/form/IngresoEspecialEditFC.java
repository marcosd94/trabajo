...
@Name("ingresoEspecialEditFC")
@Scope(ScopeType.CONVERSATION)
public class IngresoEspecialEditFC implements Serializable {
	...
	public String toFindPersonaView() {
		...
		String from="";
		if(idEmpleadoPuesto==null)
			from="/seleccion/ingresoDirecto/ingresoEspecial/IngresoEspecialEdit";
		else
			from="/seleccion/ingresoDirecto/ingresoEspecial/IngresoEspecial";
	...
	public String toFindPersona() {
		idPersona=null;
		return "/seleccion/persona/PersonaEdit.xhtml?personaFrom=/seleccion/ingresoDirecto/ingresoEspecial/IngresoEspecialEdit";
	}
	public String toFindPersonaList() {
		return "/seleccion/persona/PersonaList.xhtml?from=/seleccion/ingresoDirecto/ingresoEspecial/IngresoEspecialEdit";
	}
	...
	public void seleccionarPuesto(Long idPuesto,int index){
		...
		public String save() {
			try {
				 ...
				 * */	
				empleadoPuesto.setDatosEspecificosByIdDatosEspTipoIngresoMovilidad(seleccionUtilFormController.traerDatosEspecificos("TIPOS DE INGRESOS Y MOVILIDAD","INGRESO DIRECTO PERSONAL ESPECIAL"));
				 ...
				 * * */
				 ...
				 if(!exiteLegajo(persona.getIdPersona())){
					 ...
					 legajos.setDatosEspecificosTipoIngreso(seleccionUtilFormController.traerDatosEspecificos("TIPOS DE INGRESOS Y MOVILIDAD", "INGRESO DIRECTO PERSONAL ESPECIAL"));
					 em.persist(legajos);
				 }
			...
			try {
				List<DatosEspecificos> datosEspecificosLists =
					em.createQuery("Select d from DatosEspecificos d "
						+ " where d.datosGenerales.descripcion like 'TIPOS DE DOCUMENTOS' and d.valorAlf like 'DOC_ING_CONCURSO' and d.activo=true order by d.descripcion").getResultList();
...
//		METODOS PRIVADOS
		...
		private Long guardarAdjuntos(String fileName, int fileSize, String contentType,UploadItem file, Long idTipoDoc, Long idDocumento) {
			try {
				...
				String nombrePantalla = "ingresoEspecial_edit";
		...
		private boolean chkDatos(String op){
			...
			String grupoValidador="IDESPECIAL";
