...
@Name("personalElegibleListFC")
public class PersonalElegibleListFC{
	@In
	...
	private Long getIdTipoMovilidad(){
		return seleccionUtilFormController.traerDatosEspecificos("TIPOS DE INGRESOS Y MOVILIDAD","INGRESO DE ELEGIBLE DE CONCURSO").getIdDatosEspecificos();
	}
