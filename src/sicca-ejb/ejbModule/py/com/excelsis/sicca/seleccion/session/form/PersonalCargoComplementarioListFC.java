...
@Name("personalCargoComplementarioListFC")
public class PersonalCargoComplementarioListFC implements Serializable {
	...
	private void searchDatosEsp() {
		Query q = em
				.createQuery("select especif from DatosEspecificos especif "
						+ " where especif.activo is true and especif.descripcion = 'INGRESO DIRECTO PERSONAL CARGO COMPLEMENTARIO' "
	...
	public void search() {
		...
		empleadoPuestoList.listaResultadosCU585();
	}
