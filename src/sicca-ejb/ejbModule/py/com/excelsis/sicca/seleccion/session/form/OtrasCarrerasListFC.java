...
@Name("otrasCarrerasListFC")
public class OtrasCarrerasListFC{
	@In
	...
	private Long getIdTipoMovilidad(){
		return seleccionUtilFormController.traerDatosEspecificos("TIPOS DE INGRESOS Y MOVILIDAD","INGRESO DIRECTO PERSONAL OTRAS CARRERAS").getIdDatosEspecificos();
	}
