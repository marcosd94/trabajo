 ...
 * @author erivas
 */
public abstract class CustomQuery<T, E> extends PersistenceController<T> //TODO: extend MutableController!
{ 
   ...
   public Integer getCurrentPage()
   {
      ...
      {
		 if (getPageCount() == 0 || getPageCount() == null){
			 return page;
		 } else { 		 
			 return page + 1;
		 }
   ...
   protected String getCountEjbql()
   {
      ...
      // however, Hibernate produces queries some databases cannot run when the primary key is composite
          ...
          Matcher subjectMatcher = SUBJECT_PATTERN.matcher(ejbql.trim());
