...
@Name("funcionarioOeeFormController")
public class FuncionarioOeeFormController implements Serializable {
...
//		String result = null;
//		try {
//			if (persona.getEsFuncionario() && listDetail.isEmpty()) {
//				statusMessages.add(Severity.ERROR, SICCAAppHelper.getBundleMessage("FuncionarioOee_msg_list_empty"));
//				return null;
//			}
//			personaHome.setInstance(persona);
//			personaHome.update();
//
//			for (FuncionarioOee f : listDetail) {
//				funcionarioOeeHome.setInstance(f);
//				result = funcionarioOeeHome.save();
//				funcionarioOeeHome.clearInstance();
//			}
//			
//			statusMessages.clear();
		...
		if (modalidadOcupacionSeleccion.getValor().equals(ModalidadOcupacionSeleccion.NOMBRADO.getValor())) {
			for (FuncionarioOee func : listDetail) {
				if (func.getConfiguracionUoCab().getIdConfiguracionUo().equals(nivelEntidadOeeUtil.getIdConfigCab())
					&& func.getTipoNombramiento() != null && func.getTipoNombramiento().getIdTipoNombramiento().equals(idTipoNombramiento)) {
