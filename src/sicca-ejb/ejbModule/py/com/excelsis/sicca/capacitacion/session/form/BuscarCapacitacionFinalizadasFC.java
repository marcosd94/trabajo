...
@Name("buscarCapacitacionFinalizadasFC")
public class BuscarCapacitacionFinalizadasFC implements Serializable {
	...
	@In(create = true)
	CapacitacionFinalizadaList capacitacionFinalizadaList;
	...
	private List<CapacitacionFinalizada> capacfinalizadasListas= new ArrayList<CapacitacionFinalizada>();
	...
	public void search() {
		capacitacionFinalizadaList.setIdCiudad(idCiudad);
		capacitacionFinalizadaList.setIdDepartamento(codDepartamento);
		capacitacionFinalizadaList.setIdPais(codPais);
		capacitacionFinalizadaList.setIdTipoCapa(idTipoCapacitacion);
		capacitacionFinalizadaList.getCapacitacionFinalizada().setModalidalidad(modalidadCapaSeleccione.getValor());
		if(sugestion!=null && !sugestion.trim().equals(""))
			capacitacionFinalizadaList.getCapacitacionFinalizada().setNombre(sugestion);
		else
			capacitacionFinalizadaList.getCapacitacionFinalizada().setNombre(null);
		capacfinalizadasListas=capacitacionFinalizadaList.listaResultados();
	...
	public void searchAll() {
		...
		sugestion=null;
		capacfinalizadasListas=capacitacionFinalizadaList.limpiar();
	}
	...
	public List<String> autocompletar(String suggest) {
		...
		List<CapacitacionFinalizada> lista= new ArrayList<CapacitacionFinalizada>();
		if(suggest!=null) 
			lista=em.createQuery("Select c from CapacitacionFinalizada c where lower(c.nombre) like :desc ").setParameter("desc","%"+suggest+"%").getResultList();
		...
		for (CapacitacionFinalizada o : lista) {
	...
	public List<CapacitacionFinalizada> getCapacfinalizadasListas() {
		return capacfinalizadasListas;
	}


	public void setCapacfinalizadasListas(
			List<CapacitacionFinalizada> capacfinalizadasListas) {
		this.capacfinalizadasListas = capacfinalizadasListas;
	}
