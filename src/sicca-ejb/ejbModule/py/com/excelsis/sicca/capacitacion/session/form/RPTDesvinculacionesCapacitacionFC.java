...
@Name("rptDesvinculacionesCapacitacionFC")
public class RPTDesvinculacionesCapacitacionFC {
	...
	public void pdf() throws Exception {
		...
		try {
			...
			JasperReportUtils.respondPDF(
					"RPT_CU507_Desvinculacion_Capacitacion", param, false,
	...
	private String obtenerSqlReporte() {
		...
		String sql = "SELECT distinct(sin_entidad.id_sin_entidad) as id_sin_entidad,  "
				...
				+ "D.DESCRIPCION as MOTIVO , DET.OBSERVACION as observacion, "
				+ "DET.FECHA_DESVINCULACION as fecha_desvinculacion, "
				+ "DET.MOTIVO_HABILIT as justificativo, DET.FECHA_HABILIT as fecha_habilitacion, "
				+ "p.NOMBRES|| ' ' ||P.APELLIDOS nombres, OEE.DENOMINACION_UNIDAD OEE "
				+ "FROM sinarh.sin_nivel_entidad nivel,  "
				+ "CAPACITACION.LISTA_DET DET  "
				...
				+ "ON D.ID_DATOS_ESPECIFICOS = DET.ID_DATOS_ESPECIFICOS_DESV "
				+ "Join planificacion.entidad entidad  on OEE_CAP.id_entidad = entidad.id_entidad  "
