...
@Name("rptPersonalNivelAcademicoOEE744FC")
public class RptPersonalNivelAcademicoOEE744FC {
	...
	private String obtenerSql() throws Exception {
		...
		String sql = "SELECT DISTINCT OEE.DENOMINACION_UNIDAD AS OEE,   "+
				...
				"	, P.DOCUMENTO_IDENTIDAD, P.APELLIDOS,  P.NOMBRES, case when e.contratado = true then 'CONTRATADO' ELSE 'PERMANENTE' end AS TIPO_PERSONA,p.id_persona as id,  "+
		...
		if(documentoIdentidad!=null && !documentoIdentidad.trim().equals("")){
			sql+=" and  p.documento_identidad ='"+documentoIdentidad+"'";
		}
	...
	public void imprimir(String formato) throws Exception {
			...
			try {
				...
				reportUtilFormController.setNombreReporte("RPT_CU744");
	...
	private HashMap<String, Object> obtenerMapaParametros() throws Exception {
		...
		param.put("documentoIdentidad", documentoIdentidad);
