 ...
 */
@Entity
@Table(name = "sin_anx_original_tmp", schema = "sinarh")
public class SinAnxOriginalTmp implements java.io.Serializable {

	private Long idAnxOriginalTmp;
	...
	public SinAnxOriginalTmp() {
	}

	public SinAnxOriginalTmp(Long idAnxOriginal, Integer aniAniopre, Integer nenCodigo,
			...
			Integer dptCodigo) {
		this.idAnxOriginalTmp = idAnxOriginal;
	...
	@Id
	@GeneratedValue(generator="SIN_ANX_ORIGINAL_TMP_GENERATOR")
	@SequenceGenerator(name="SIN_ANX_ORIGINAL_TMP_GENERATOR",sequenceName="sinarh.sin_anx_original_tmp_id_anx_original_tmp_seq")
	@Column(name = "id_anx_original_tmp", unique = true, nullable = false)
	public Long getIdAnxOriginalTmp() {
		return this.idAnxOriginalTmp;
	}

	public void setIdAnxOriginalTmp(Long idAnxOriginal) {
		this.idAnxOriginalTmp = idAnxOriginal;
	}
