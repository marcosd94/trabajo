...
*/
@Entity
@Table(name = "bandeja_entrada", schema = "proceso")
public class BandejaEntrada implements java.io.Serializable {
...
//	private String codigoUsuario;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BandejaEntrada))
			return false;
		BandejaEntrada castOther = (BandejaEntrada) other;
