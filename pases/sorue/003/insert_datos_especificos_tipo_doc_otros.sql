--TABLA DATOS_ESPECIFICOS, INSERCION DE REGISTRO PARA TIPO DE DOCUMENTO "OTROS" PARA DATOS SALUD (TIPO DE SANGRE)
...
INSERT INTO seleccion.datos_especificos(id_datos_especificos, descripcion, valor_alf, valor_num, id_datos_generales, 
    ...
    VALUES (nextVal('seleccion.sel_datos_especificos_id_datos_especificos_seq'), 'OTROS', 'CRTS', NULL, 2, 
