...
--DEPORTES se mantendra , no se encontraron registros duplicados where anho= 2015 and mes=5 and id_configuracion_uo = 73;.
...
DELETE FROM remuneracion.historico_remuneraciones_tmp where anho= 2015 and mes=6 and id_configuracion_uo = 113 and usu_alta = 'SYSTEM';
