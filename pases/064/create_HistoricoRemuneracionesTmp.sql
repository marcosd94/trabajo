-- Table: remuneracion.historico_remuneraciones_tmp

-- DROP TABLE remuneracion.historico_remuneraciones_tmp;

CREATE TABLE remuneracion.historico_remuneraciones_tmp
(
  id_historico_remuneracion_tmp bigserial NOT NULL,
  ...
  CONSTRAINT historico_remuneraciones_tmp_pk PRIMARY KEY (id_historico_remuneracion_tmp)
